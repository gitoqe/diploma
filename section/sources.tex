...
% =-=-=-=-=-=-=-=-=-=-=- ././ =-=-=-=-=-=-=-=-=-=-=-
    ...
    \bibitem{kiyamov-cms-1}
        ...
        --
        URL:
        \href{http://azericms.com/chto-takoe-cms/}{http://azericms.com/chto-takoe-cms/}
    ...
    \bibitem{wiki-json}
        ...
        --
        URL:
        \href{https://ru.wikipedia.org/wiki/JSON}{https://ru.wikipedia.org/wiki/JSON}
        (дата обращения: 01.05.2022).
        --
        Текст: электронный.

    \bibitem{npm-passport}
        passport - npm
        --
        URL:
        \href{https://www.npmjs.com/package/passport}{https://www.npmjs.com/package/passport}
        (дата обращения: 01.05.2022).
        --
        Текст: электронный.
        
    \bibitem{npm-jsonwebtoken}
        jsonwebtoken - npm
        --
        URL:
        \href{https://www.npmjs.com/package/jsonwebtoken}{https://www.npmjs.com/package/jsonwebtoken}
        (дата обращения: 01.05.2022).
        --
        Текст: электронный.
    ...
    \bibitem{google-lato}
        ...
        --
        URL:
        \href{https://fonts.google.com/specimen/Lato}{https://fonts.google.com/specimen/Lato}
        (дата обращения: 01.05.2022).
        --
        Текст: электронный.

    \bibitem{google-nunito}
        Nunito - Google Fonts
        --
        URL:
        \href{https://fonts.google.com/specimen/Nunito}{https://fonts.google.com/specimen/Nunito}
        (дата обращения: 01.05.2022).
        --
        Текст: электронный.
    ...
    \bibitem{fontawesome}
        ...
        --
        URL:
        \href{https://fontawesome.com/}{https://fontawesome.com/}
        (дата обращения: 01.05.2022).
        --
        Текст: электронный.
