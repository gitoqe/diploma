...
% \renewcommand{\longtable}{\thesection.\arabic{table}}
...
\captionsetup[figure]{font=small, justification=centering, labelsep=defffis, format=plain} % Подпись рисунка по центру
...
% \captionsetup[longtable]{justification=raggedright, labelsep=defffis, format=plain, singlelinecheck=false}
...
\setlength{\cftsubsecindent}{1cm} % Также повлияет на отступ в содержании
